...
python3 generate_code.py \
        ...
        --save "generated_codes_1_3B_100_problems_introductory.json" \
        -t "0xsuid/simba-1.3b" \
        -m "0xsuid/simba-1.3b"
...
python3 generate_code.py \
        ...
        --save "generated_codes_1_3B_100_problems_competition.json" \
        -t "0xsuid/simba-1.3b" \
        -m "0xsuid/simba-1.3b"
...
python3 generate_code.py \
        --limit 100 \
        --difficulties "introductory" \
        --save "generated_codes_125M_100_problems_introductory.json" \
...
python3 generate_code.py \
        --limit 100 \
        --difficulties "interview" \
        --save "generated_codes_125M_100_problems_interview.json" \
        -t "EleutherAI/gpt-neo-125M" \
        -m "0xsuid/simba-125M"
