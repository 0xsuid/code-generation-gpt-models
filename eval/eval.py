...
generated_code = json.load(open("/home/user/code-generation-gpt-models/data/generated_code/GPT-Neo-1.3B/generated_codes_1_3B_100_problems_introductory.json", "r"))
solutions = []
